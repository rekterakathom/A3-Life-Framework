...
_arrested = [_arrested] call DB_fnc_bool;
...
switch (_side) do {
    ...
    case civilian: {_query = format ["UPDATE players SET name='%1', cash='%2', bankacc='%3', civ_licenses='%4', civ_gear='%5', arrested='%6', civ_stats='%7', civ_alive='%8', civ_position='%9', playtime='%10' WHERE pid='%11'",_name,_cash,_bank,_licenses,_gear,_arrested,_stats,_alive,_position,_playtime_update,_uid];};
